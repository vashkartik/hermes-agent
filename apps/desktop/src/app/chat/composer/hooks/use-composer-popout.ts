 ...
 * window's composer out via the shared atom. Pop-out is also a desktop pointer
 * affordance: mobile/coarse-pointer embeds stay docked so a saved desktop float
 * position cannot shrink or offset the phone composer.
 */
