...
import { $activeGatewayProfile, $freshSessionRequest, $newChatProfile, $profileScope, refreshActiveProfile } from '../store/profile'
...
const MemoriesView = lazy(async () => ({ default: (await import('./memories')).MemoriesView }))
